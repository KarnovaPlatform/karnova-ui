const Config = {
    ...
    skins: [
        {
            name: "smart-style-0",
            logo: "assets/img/logo_karnova.jpg", // "assets/img/logo.png",
        ...
        {
            name: "smart-style-1",
            logo: "assets/logo_karnova.jpg", // "assets/img/logo-white.png",
        ...
        {
            name: "smart-style-2",
            logo: "assets/img/logo_karnova.jpg", // "assets/img/logo-blue.png",
        ...
        {
            name: "smart-style-3",
            logo: "assets/img/logo_karnova.jpg", // "assets/img/logo-pale.png",
